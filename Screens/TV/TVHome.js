import { View, Text, Image, StyleSheet, ScrollView, FlatList, Pressable, RefreshControl,Animated,Dimensions,TouchableOpacity } from 'react-native';
...
export default function TVHome({navigation}) {
  ...
  return (
    <View style={styles.view}>
      <TouchableOpacity style={{top:"2%",right:"-90%",height:"auto",width:70,backgroundColor:'rgba(10,100,10,.3)',justifyContent:'center',alignItems:'center',borderRadius:5}}
        onPress={()=>{
