import { View, Text, Image, StyleSheet, ScrollView, FlatList, Pressable, RefreshControl, Touchable,Dimensions } from 'react-native';
import React, { useState, useEffect, useContext } from 'react';
import axios from 'axios';
import AsyncStorage from '@react-native-async-storage/async-storage'
import { useRefresh } from '../../componets/MovieContext';
import { TouchableOpacity } from 'react-native-gesture-handler';
export default function TVWishList({navigation}) {
